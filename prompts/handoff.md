...
1. **Hand off** — Say something like: _"Implement the X logic in src/foo.ts at the HANDOFF marker, then reply 'next' to continue."_

1. **Wait** — Do not proceed until the human says they're done.

1. **Continue** — Verify the portion is done (optional quick scan), then move to the next portion.
