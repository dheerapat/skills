...
Last updated Jul 21, 2026[View as Markdown](https://flueframework.com/docs/cli/run/index.md)
...
| --data <json>        | Instance-creation data, read inside the agent with [useInitialData()](https://flueframework.com/docs/guide/agent-hooks/). Consulted only when this run creates the conversation; silently ignored on continues. Cannot be combined with --uid. |
