...
Last updated Jul 21, 2026[View as Markdown](https://flueframework.com/docs/guide/why-flue/index.md)
...
- **[Agents](https://flueframework.com/docs/guide/building-agents/):** Autonomous agents that keep context across conversations and events.
- **[Sandboxes](https://flueframework.com/docs/guide/sandboxes/):** A secure environment where agents run code and do real work.
- **[Subagents](https://flueframework.com/docs/guide/subagents/):** Let your agent delegate specialized work to the right expert.
- **[Skills](https://flueframework.com/docs/guide/skills/):** Package expertise that agents load whenever a task needs guidance.
- **[Tools](https://flueframework.com/docs/guide/tools/):** Agents call APIs, query data, and make changes — using the code you define.
- **[MCP Servers](https://flueframework.com/docs/guide/mcp/):** Connect agents to thousands of tools in the open MCP ecosystem.
- **[Persistent State](https://flueframework.com/docs/guide/agent-hooks/#persisted-state):** Write data on each agent and update its capabilities as state changes.
- **[Chat](https://flueframework.com/docs/guide/channels/):** Drop your agents into Slack, Teams, Discord, GitHub, and more.
...
1. **[Dynamic](#dynamic):** An agent is a program to write, not an object to configure.
1. **[Durable](#durable):** We do the hard work of durability so you don’t have to.
1. **[Open](#open):** Open models, sandboxes, and hosting platforms — no lock-in.
1. **[Built to scale](#built-to-scale):** Designed for non-trivial agents — from a starter project to a billion-dollar company.
...
See [Agents](https://flueframework.com/docs/guide/building-agents/) to learn more.
...
Together, functions and hooks make agents reactive and stateful. With [persistent state](https://flueframework.com/docs/guide/agent-hooks/#persisted-state), an agent has literal state: data it can read and write across its whole conversation. Capabilities can follow that state — a tool that appears once prerequisites are met, a [sandbox](https://flueframework.com/docs/guide/sandboxes/) that attaches only when the task calls for one. Agents are written like components because web developers already know how to program declarative, reactive systems.

See [Agent Hooks](https://flueframework.com/docs/guide/agent-hooks/) for the full toolkit.
...
See [Durability](https://flueframework.com/docs/guide/durability/) for the exact contract on each deploy target.
...
The same openness applies to protocols: Flue builds on open standards like [MCP](https://flueframework.com/docs/guide/mcp/) and [Durable Streams](https://durablestreams.com/) instead of inventing its own.

See [Sandboxes](https://flueframework.com/docs/guide/sandboxes/) and [Deploy](https://flueframework.com/docs/guide/deploy/) for more details.
...
Current page: [Why Flue?](https://flueframework.com/docs/guide/why-flue/)
